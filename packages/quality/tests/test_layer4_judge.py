...
class TestQualityReview:
    @pytest.mark.asyncio
    async def test_returns_quality_scores_and_passed(self):
    ...
    @pytest.mark.asyncio
    async def test_quality_scores_is_judge_output_dict(self):
        from packages.agents.sub_agents.reviewer.agent import quality_review
    ...
    @pytest.mark.asyncio
    async def test_missing_artifacts_uses_empty_list(self):
        from packages.agents.sub_agents.reviewer.agent import quality_review
