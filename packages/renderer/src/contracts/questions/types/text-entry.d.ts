...
export type TextEntryQuestion = Cloze | ShortAnswer | GrammarTransformation | ReportedSpeech | PassiveVoice | ConditionalBuilder | ErrorCorrection | SentenceManipulation | ReadingComprehension;
