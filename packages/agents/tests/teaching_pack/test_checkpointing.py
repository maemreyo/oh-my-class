...
from packages.agents.teaching_pack.checkpointing import open_teaching_pack_postgres_checkpointer


class TestTeachingPackCheckpointing:
    def test_opens_postgres_checkpointer_context(self) -> None:
        ...
        with (
            ...
            open_teaching_pack_postgres_checkpointer("postgresql://db") as opened,
        ):
    ...
    def test_can_skip_setup_for_unit_tests(self) -> None:
        ...
        with (
            patch.dict(sys.modules, {"langgraph.checkpoint.postgres": postgres_module}),
            open_teaching_pack_postgres_checkpointer("postgresql://db", setup=False),
        ):
            pass
