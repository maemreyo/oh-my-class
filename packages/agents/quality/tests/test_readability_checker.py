...
class TestCheckReadability:
    def test_empty_text_passes(self):
        from packages.agents.quality.readability_checker import check_readability
    ...
    def test_max_deviation_constant(self):
        from packages.agents.quality.readability_checker import MAX_DEVIATION
        assert MAX_DEVIATION == 2.0

    def test_passes_when_deviation_exactly_at_limit(self):
        from packages.agents.quality.readability_checker import ReadabilityResult, MAX_DEVIATION
