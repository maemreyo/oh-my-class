...
class TestTeachingPackPreviews:
    ...
    def test_student_preview_redacts_teacher_only_content(self, client: TestClient) -> None:
        ...
        response = client.get(f"/teaching-packs/run/{run_id}/snapshots/{snapshot_id}/preview")
    ...
    def test_non_owner_cannot_access_snapshot(
        ...
        response = other_teacher_client.get(f"/teaching-packs/run/{run_id}/snapshots/{snapshot_id}")
