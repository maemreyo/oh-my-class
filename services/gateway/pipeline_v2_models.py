...
from services.gateway.pipeline_v2_artifact_models import (  # noqa: F401
    ArtifactCheckStatus,
    ArtifactWorkflow,
    ArtifactWorkflowStatus,
)
from services.gateway.pipeline_v2_snapshot_models import ArtifactSnapshot  # noqa: F401
...
class PipelineV2EventVisibility(StrEnum):
    TEACHER = "teacher"
    ADMIN = "admin"
    INTERNAL = "internal"
...
class RunEvent(Base):
    ...
    stage: Mapped[str | None] = mapped_column(String(64), nullable=True)
    visibility: Mapped[PipelineV2EventVisibility] = mapped_column(
        Enum(PipelineV2EventVisibility, native_enum=False), nullable=False,
    )
