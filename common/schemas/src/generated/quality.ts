...
export const ArtifactQualityReportSchema = z.object({ "artifact_id": z.string(), "artifact_type": z.string(), "passed": z.boolean(), "issues": z.array(z.lazy(() => QualityIssueSchema)).optional() })
...
export const ExportReadinessReportSchema = z.object({ "run_id": z.string(), "passed": z.boolean(), "approved_snapshot_ids": z.array(z.string()).optional(), "issues": z.array(z.object({ "failure_class": z.any(), "location": z.string(), "message": z.string(), "hard_block": z.boolean().default(true) })).optional() })
