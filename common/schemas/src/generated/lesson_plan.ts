...
export const MethodologyMetadataSchema = z.object({ "tags": z.array(z.enum(["concept_map","contrastive_pairs","film_based","shy_student_1on1","active_recall","why_wrong_reasoning","timed_quiz","roleplay_script","inverse_thinking","semantic_anchoring"])).optional(), "target_skill_area": z.union([z.string(), z.null()]).default(null), "student_profile_notes": z.union([z.string(), z.null()]).default(null), "payloads": z.lazy(() => MethodologyPayloadsSchema).optional() })
