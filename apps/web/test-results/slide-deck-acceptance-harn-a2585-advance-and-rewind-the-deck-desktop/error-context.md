...
```
Error: SLIDE_DECK_EXPORT_HTML must point at a real exported HTML file (got: .scratch/slide-deck-acceptance/artifacts/exports/vietnamese_classroom_deck.snap-e18cb4e3bd2140bca9519c66.student.html)
```
