...
MODELS: dict[str, ModelConfig] = {
    ...
    "common.contracts.vocabulary_batch": {
        "main_model": "SemanticAnchorCluster",
        "all_models": [
        ...
        "output": "common/schemas/src/generated/vocabulary_batch.ts",
        "field_refs": {
            "anchors": "AnchorCard",
            "items": "PracticeItem",
            ...
            "term_definitions": "LexicalTermDefinition",
            "usage_constraints": "LexicalUsageConstraint",
            "example_pairs": "LexicalExamplePair",
            "cache_keys": "LexicalGroundingCacheKeys",
        },
        "external_field_refs": {},
    },
    "common.contracts.vocabulary_cluster_workflow": {
        "main_model": "VocabularyClusterWorkflow",
        "all_models": [
            "VocabularyClusterWorkflow",
            "VocabularyClusterEvidenceEntry",
        ],
        "output": "common/schemas/src/generated/vocabulary_cluster_workflow.ts",
        "field_refs": {},
        "external_field_refs": {},
    },
}
