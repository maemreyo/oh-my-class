...
MODELS: dict[str, ModelConfig] = {
    ...
    "common.contracts.slide_deck": {
        ...
        "output": "common/schemas/src/generated/slide_deck.ts",
        "field_refs": {
            "display_preferences": "SlideDeckDisplayPreferences",
            ...
            "source_refs": "SlideDeckSourceRef",
            "slides": "SlideDeckSlide",
            "progression": "SlideDeckProgression",
            "blocks": "SlideDeckBlock",
            "media": "SlideDeckMedia",
            "interactions": "SlideDeckInteraction",
            "options": "SlideDeckInteractionOption",
            "teacher_only": "SlideDeckInteractionTeacherOnly",
            "teacher_notes": "SlideDeckTeacherOnly",
            "differentiation_guidance": "SlideDeckDifferentiationNote",
            "accessibility": "SlideDeckAccessibility",
            "media_policy": "SlideDeckMediaPolicy",
        },
        "external_field_refs": {},
    },
    "common.contracts.component_strategy": {
        "main_model": "ComponentStrategyResult",
        "all_models": [
        ...
        "output": "common/schemas/src/generated/component_strategy.ts",
        "field_refs": {
            "plan": "ComponentStrategyPlan",
            "recommended": "StrategyVariant",
            "variants": "StrategyVariant",
            "learning_sequence": "StrategySlot",
            "budget": "StrategySlotBudget",
            "artifact_strategies": "ArtifactStrategyProjection",
            "export_projection_status": "ExportProjectionStatus",
            "fallback_metadata": "FallbackMetadata",
            "quality_score": "StrategyQualityScore",
            "warnings": "StrategyWarning",
            "revision": "StrategyRevision",
            "objective_refs": "ObjectiveRef",
