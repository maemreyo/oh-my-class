"""E2E scenarios for Pipeline V2 — real-world use cases.
...
class TestScenarioVietnameseGrade5Math:
    ...
    async def test_equivalent_fractions_full_lifecycle(self, session: AsyncSession) -> None:
        ...
        await store.write_event(PipelineV2EventCreate(
            run_id=run_id,
            event_name="pipeline_v2.contract_confirmation.opened",
        ...
        await store.write_event(PipelineV2EventCreate(
            run_id=run_id,
            event_name="pipeline_v2.contract_confirmation.responded",
            visibility=PipelineV2EventVisibility.TEACHER,
